...
Usage examples:
  python build_pta_moore_aalpy.py --folder "/path/to/traces" --pattern "Trace_*.txt" --out_dir out
  python build_pta_moore_aalpy.py --input  "/path/to/traces/Trace_1st.txt" --out_dir out
...
def main() -> None:
    ...
    summary = {
        ...
        "pta_states_reachable": n_states,
        "pta_edges_reachable": n_edges,
        "dot_file": out_dot,
    }
    with open(os.path.join(out_dir, "pta_summary.json"), "w", encoding="utf-8") as f:
